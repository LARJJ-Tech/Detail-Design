...
function Pamb = Pamb(data, cond)
    [~,~,Pamb] = atmosisa(data{"Altitude",cond});
end
...
t1 = [Pamb(data,cond)/1000;Tamb(data,cond);data{["Mach Number" "HPT Stator Outlet Temp T405" "Overall Pressure Ratio P3/P2" "LPC Inner Pressure Ratio" "Bypass Ratio" "Net Thrust"],cond}; ...
